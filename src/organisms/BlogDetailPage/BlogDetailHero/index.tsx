    ...
    <section className="blog-detail-hero">
      <div className="container">
        ...
        <div className="blog-img">
            <img src="https://res.cloudinary.com/dpb8gwksd/image/upload/v1703579014/food-web/blog-details-1_ziuu8m.png" alt="blog-details" />
        </div>
        ...
        <div className="blog-img">
            <img src="https://res.cloudinary.com/dpb8gwksd/image/upload/v1703579015/food-web/blog-details-2_jfnxio.png" alt="blog-details" />
        </div>
        <div className="content">
          <h4 className='sub-title'>What do you need to prepare a home-made burger?</h4>
